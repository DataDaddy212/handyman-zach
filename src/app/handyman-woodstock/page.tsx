...
export const metadata: Metadata = {
  ...
  description: "Professional handyman services in Woodstock, NY. TV mounting, bike repair, lawn care, deck repair, and painting. Call (347) 623-6959 for reliable local service.",
}

export default function HandymanWoodstock() {
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-amber-400 via-orange-300 to-blue-400 py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6 font-heading leading-tight">
            Trusted Handyman in Woodstock, NY
          </h1>
          <p className="text-xl lg:text-2xl text-white/90 mb-8 leading-relaxed">
            Professional handyman services in Woodstock and surrounding areas. From TV mounting to deck repair, 
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16 text-gray-900 font-heading">Services in Woodstock</h2>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Contact Handyman Zach for reliable service in Woodstock, NY
          </p>
          <a 
            href="tel:3476236959" 
